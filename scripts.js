...
function throwChoice() {
  ...
  browser_text= document.getElementById("browser");
  var winner;
  ...
  throw_button.addEventListener("click", function() {
    ...
    browser_choice = Math.floor(Math.random() * 3)+1;
    ...
    if (player_choice == 0) {
      ...
      browser_stats[possible_choices[browser_choice-1]]+=1;

      $("#player_image").attr("src", "images/player_"+possible_choices[player_choice-1]+".png");
      $("#browser_image").attr("src", "images/browser_"+possible_choices[browser_choice-1]+".png");
      ...
      browser_text.innerHTML = "The computer threw "+possible_choices[browser_choice-1]+ "!";
      printStats();
